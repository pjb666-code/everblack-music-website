...
import { useTermsOfService } from "@/hooks/useQueries";
import { Link } from "@tanstack/react-router";
import { ArrowLeft, Calendar, Info, ScrollText } from "lucide-react";
...
export default function TermsOfServicePage() {
  ...
  useEffect(() => {
    document.title = "Nutzungsbedingungen – Everblack Music";
  }, []);
          ...
          {isLoading ? (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Nutzungsbedingungen hinterlegt.
              </p>
            </div>
          )}
