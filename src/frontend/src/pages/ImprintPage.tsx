...
import { useImprint } from "@/hooks/useQueries";
...
export default function ImprintPage() {
  const { data, isLoading } = useImprint();

  useEffect(() => {
    document.title = "Impressum – Everblack Music";
  }, []);
        ...
        <div className="max-w-3xl mx-auto">
          {isLoading ? (
            ...
            <div
              ...
              data-ocid="imprint-empty"
            >
              <Info className="w-10 h-10 text-muted-foreground mx-auto mb-4" />
              <p className="text-muted-foreground text-sm">
                Kein Inhalt verfügbar. Der Administrator hat noch kein Impressum
                hinterlegt.
              </p>
            </div>
          )}
